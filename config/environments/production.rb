Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "mobile-friendly-ru_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'warm-retreat-30658.herokuapp.com' }
end
